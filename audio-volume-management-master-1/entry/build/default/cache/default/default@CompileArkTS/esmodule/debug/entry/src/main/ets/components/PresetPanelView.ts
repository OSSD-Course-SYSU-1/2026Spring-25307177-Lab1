...
export class PresetPanelView extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.presetNameDialogController = new CustomDialogController({
            builder: () => {
                ...
                }, undefined, -1, () => { }, { page: "entry/src/main/ets/components/PresetPanelView.ets", line: 159, col: 14 });
        ...
        this.duplicateDialogController = new CustomDialogController({
            builder: () => {
                ...
                }, undefined, -1, () => { }, { page: "entry/src/main/ets/components/PresetPanelView.ets", line: 171, col: 14 });
    ...
    buildPresetList(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isTablet()) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.buildGridLayout.bind(this)();
                });
            }
            else {
                this.ifElseBranchUpdateFunction(1, () => {
                    this.buildListLayout.bind(this)();
                });
            }
        }, If);
        If.pop();
    }
    buildGridLayout(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Grid.create();
            Grid.columnsTemplate('1fr 1fr');
            Grid.rowsGap(PresetConstants.LIST_SPACE);
            Grid.columnsGap(PresetConstants.LIST_SPACE);
            Grid.width('100%');
            Grid.height(this.presetList.length > 0 ? Math.ceil(this.presetList.length / 2) * (PresetConstants.LIST_ITEM_HEIGHT + PresetConstants.LIST_SPACE) : 0);
        }, Grid);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
                        ...
                        this.observeComponentCreation2(itemCreation2, GridItem);
                        {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                if (isInitialRender) {
                                    ...
                                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/components/PresetPanelView.ets", line: 425, col: 11 });
    ...
    buildListLayout(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create({ space: PresetConstants.LIST_SPACE });
            List.width('100%');
            List.height(this.presetList.length * (PresetConstants.LIST_ITEM_HEIGHT + PresetConstants.LIST_SPACE));
        }, List);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
            const forEachItemGenFunction = _item => {
                        ...
                        itemCreation(elmtId, isInitialRender);
                        {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                if (isInitialRender) {
                                    ...
                                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/components/PresetPanelView.ets", line: 448, col: 11 });
                                    ViewPU.create(componentCall);
                                    let paramsLambda = () => {
                                        return {
                                            preset: preset,
