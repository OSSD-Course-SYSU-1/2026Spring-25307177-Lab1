...
import { PresetPanelView } from "@normalized:N&&&entry/src/main/ets/components/PresetPanelView&";
import { PresetService } from "@normalized:N&&&entry/src/main/ets/service/PresetService&";
    ...
    }, Column);
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                ...
                // 预设管理面板
                PresetPanelView(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Player.ets", line: 43, col: 5 });
                ViewPU.create(componentCall);
                let paramsLambda = () => {
                    return {};
                };
        ...
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new VolumePanelView(parent ? parent : this, {
                    text: { "id": 16777224, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" },
                    volumeVisible: true,
                    volumeType: VolumeType.AUDIOSTREAM,
                    Percentage: 50
                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Player.ets", line: 73, col: 7 });
                ViewPU.create(componentCall);
                let paramsLambda = () => {
                    return {
                        text: { "id": 16777224, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" },
        ...
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new VolumePanelView(parent ? parent : this, {
                    ...
                    Percentage: 50
                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Player.ets", line: 82, col: 7 });
                ViewPU.create(componentCall);
                let paramsLambda = () => {
                    return {
                        text: { "id": 16777222, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" },
...
class Player extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__sheetHeight = new ObservedPropertySimplePU(550, this, "sheetHeight");
    ...
    aboutToAppear(): void {
        ...
        if (this.audioRendererController) {
            PresetService.getInstance().setAudioRendererController(this.audioRendererController);
        }
    ...
    keyIntercept(): void {
        try {
            ...
            this.volumeUpCallBackFunc = (event: KeyEvent) => {
                if (this.isDisabled) {
                    this.getUIContext().getPromptAction().showToast({ message: { "id": 16777252, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" } });
                    return;
                }
            ...
            this.volumeDownCallBackFunc = (event: KeyEvent) => {
                if (this.isDisabled) {
                    this.getUIContext().getPromptAction().showToast({ message: { "id": 16777251, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" } });
                    return;
                }
                this.systemVolumeVisible = true;
                this.volume = this.volume - 1;
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                }, Stack);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            SetVolume(this, { volume: this.volume }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Player.ets", line: 206, col: 9 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {
                                    volume: this.volume
                ...
                }, Column);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Player.ets", line: 209, col: 11 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {
                                    volume: this.volume,
                ...
                Blank.pop();
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new ControlAreaComponent(this, { songData: songDataList[0], imageColor: this.imageColor }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Player.ets", line: 246, col: 11 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {
    ...
    NavDestinationTitle(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777258, "type": 20000, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Image.width(20);
            Image.height(20);
        }, Image);
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.bindSheet({ value: this.isShow, changeEvent: newValue => { this.isShow = newValue; } }, { builder: () => {
                ...
                title: { title: { "id": 16777249, "type": 10003, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" } }
            });
            Row.onClick(() => {
                this.isShow = true;
            });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777270, "type": 20000, params: [], "bundleName": "com.example.audiostreamvolumemanagement", "moduleName": "entry" });
            Image.width(24);
            Image.height(24);
        }, Image);
        Row.pop();
